...
<body>
  <section class="landingPage h-full">
    ...
    <form class="flex flex-col gap-4  mx-auto w-full md:w-1/2 bg-gray-50 p-8  rounded shadow" method="POST">
      ...
      <input type="url" name="country_img" id="country-img" class="p-2 border border-green-900 rounded" placeholder="Enter image URL">

      <button type="submit" name="submit" class="mt-4 bg-green-950 text-white py-2 px-4 rounded hover:bg-green-700 transform duration-300">Add Country</button>
    </form>
